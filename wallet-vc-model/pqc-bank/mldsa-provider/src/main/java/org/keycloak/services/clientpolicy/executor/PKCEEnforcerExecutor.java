...
public class PKCEEnforcerExecutor implements ClientPolicyExecutorProvider<PKCEEnforcerExecutor.Configuration> {
    ...
    private void validate(ClientRepresentation rep) throws ClientPolicyException {
        ...
        if (pkceMethod != null && (pkceMethod.equals(OAuth2Constants.PKCE_METHOD_S256) || pkceMethod.equals("S384"))) return;
    ...
    private boolean isAcceptableCodeChallengeMethod(String method) {
        return OAuth2Constants.PKCE_METHOD_S256.equals(method) || "S384".equals(method);
     }
    ...
    private void verifyCodeVerifier(String codeVerifier, String codeChallenge, String codeChallengeMethod) throws ClientPolicyException {
        ...
        try {
            ...
            } else if (codeChallengeMethod != null && codeChallengeMethod.equals("S384")) {
                codeVerifierEncoded = generateS384CodeChallenge(codeVerifier);
            } else {
    ...
    private String generateS384CodeChallenge(String codeVerifier) throws Exception {
