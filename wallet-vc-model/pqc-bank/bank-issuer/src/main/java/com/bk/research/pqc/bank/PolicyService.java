...
public class PolicyService {
        ...
        try {
            ...
            if (resource.exists()) {
                try (InputStream is = resource.getInputStream()) {
                    ...
                    System.out.println("[PolicyService] Central Policy Engine initialized. Version: " + version + ", Master Scope Count: " + masterScopeCatalog.size() + ", Identity Claims Count: " + masterIdentityClaims.size());
                }
            } else {
    ...
    public Set<String> getEntitledScopesForUser(String accountType) {
        ...
        result.retainAll(masterScopeCatalog); // Ensure strictly sub-scopes of Master Catalog
        return result;
    }
