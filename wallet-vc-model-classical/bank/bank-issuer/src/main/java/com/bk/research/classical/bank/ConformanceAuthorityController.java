...
/** Controlled policy-state fixture. It is absent outside the conformance profile. */
@RestController
@Profile("conformance")
...
public class ConformanceAuthorityController {
    ...
    public ConformanceAuthorityController(TypedAuthorityService authorityService) {
